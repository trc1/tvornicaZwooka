    ...
    <table className="playlist-table" role="table" aria-label="Playlist Table">
      <thead className="playlist-table__header">
        <tr className="playlist-table__header-row" role="row">
          <th className="playlist-table__header-cell" role="columnheader">
            #
          </th>
          <th className="playlist-table__header-cell" role="columnheader">
            Title
      ...
      <tbody className="playlist-table__body">
        {playlist.map((item) => (
          <tr key={item.id} className="playlist-table__body-row" role="row">
            <td className="playlist-table__body-cell" role="cell">
              {item.id}
            </td>
            <td className="playlist-table__body-cell" role="cell">
              <TitleCell
